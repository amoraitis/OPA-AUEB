...
{
    string[] heders = { "Τμήμα Διεθνών και Ευρωπαϊκών Οικονομικών Σπουδών",
        "Τμήμα Οικονομικής Επιστήμης",
        "Tμήμα Διοικητικής Επιστήμης & Τεχνολογίας",
    ...
    string[] mails = new string[] { "deossecr@aueb.gr",
        "econ@aueb.gr","dmst@aueb.gr","ode@aueb.gr",
        "accfin@aueb.gr","secretary.marketing@aueb.gr",
        "infotech@aueb.gr","prosec@aueb.gr" };
